...
public class MainFormController {
    ...
    private void changeDesignButton(JFXButton button) throws IOException {
        button.setStyle("-fx-background-color:   #40A578; -fx-text-fill:  #9DDE8B; -fx-border-color: #FFFFFF; -fx-border-width: 3; -fx-border-radius: 5; -fx-background-radius: 10;");
    }

    private void defaultDesignButton() {
        String style = "-fx-background-color: #9DDE8B; -fx-text-fill: #40A578; -fx-border-color:  white; -fx-border-width: 3; -fx-border-radius: 5; -fx-background-radius: 10;";
